...
Muntazer = getenv("muntazer", "xswaiF")
...
OWNER_ID = int(getenv("OWNER_ID", "6467464623"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/x_x77x")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/x_x77x")
